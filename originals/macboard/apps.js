...
document.addEventListener("DOMContentLoaded", function () {
  ...
  soundElements.forEach((selement) => {
    ...
    favoritesound.innerHTML =
      '<img src="/SchoolNetV2/media/star-regular.svg" id="favoritesound" title="Favorite Sound">';
    ...
    let soundName = selement
      ...
      .getAttribute("src");
    downloads.innerHTML = `<img src="/SchoolNetV2/media/download.svg" title="Download Sound">`;
    ...
    thing.forEach((game) => {
      ...
      if (item === one) {
        ...
        game
          ...
          .setAttribute("src", "/SchoolNetV2/media/star-solid.svg");
      }
    });
  });
